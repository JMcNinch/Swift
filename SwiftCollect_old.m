...
f = msgbox({'Halo6: port 6132 & 236.6.7.100';'4G: port 7507 & 236.6.10.19 ';'JRC: port 6678 & 236.6.7.8 '},'Ethernet guide','custom',grdimage);
...
%%%%%%%%%%CREATE INSTRUCTION MESSAGE BOX%%%%%%%%%%%%%%%%
f = msgbox({'1/4nm Navico=~800m Range';'1/2nm Navico=~1600m Range';'3/4nm Navico=~2500m Range'},'Range Settings','custom',grdimage);
